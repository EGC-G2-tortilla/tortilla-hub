...
class StagingArea(TaskSet):
    ...
    def get_staging_area(self):
        with self.client.get(
            "/dataset/list", name="Get Staging Area", catch_response=True
        ) as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def stage_all_datasets(self):
        with self.client.post(
            "/dataset/stage/all", name="Stage All Datasets", catch_response=True
        ) as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def unstage_all_datasets(self):
        with self.client.post(
            "/dataset/unstage/all", name="Unstage All Datasets", catch_response=True
        ) as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def stage_dataset(self):
        with self.client.post(
            "/dataset/stage/255", name="Stage Dataset", catch_response=True
        ) as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def unstage_dataset(self):
        with self.client.post(
            "/dataset/unstage/255", name="Stage Dataset", catch_response=True
        ) as response:
            if response.status_code == 200:
                response.success()
            else:
    ...
    def publish_dataset(self):
        with self.client.post(
            "/dataset/publish", name="Publish Dataset", catch_response=True
        ) as response:
            if response.status_code == 200:
                response.success()
            else:
