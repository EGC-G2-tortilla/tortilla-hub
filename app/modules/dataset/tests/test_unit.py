...
def test_client(test_client):
    with test_client.application.app_context():
        ...
        ds_meta1 = DSMetaData(title="Dataset 1", dataset_doi="doi1", ds_metrics_id=ds_metrics1.id, description="description1...", publication_type=PublicationType.BOOK)
        ds_meta2 = DSMetaData(title="Dataset 2", dataset_doi="doi2", ds_metrics_id=ds_metrics2.id, description="description2...", publication_type=PublicationType.BOOK)
        ds_meta3 = DSMetaData(title="Dataset 3", dataset_doi="doi3", ds_metrics_id=ds_metrics3.id, description="description3...", publication_type=PublicationType.REPORT)
        ds_meta4 = DSMetaData(title="Dataset 4", dataset_doi="doi4", ds_metrics_id=ds_metrics4.id, description="description4...", publication_type=PublicationType.BOOK)
        ...
        db.session.add_all([download_record1, download_record2, download_record3, download_record4, download_record5, download_record6, download_record7, download_record8, download_record9, download_record10])
        db.session.commit()
