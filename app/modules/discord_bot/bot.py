...
async def help(interaction: nextcord.Interaction):
    ...
    commands_info = {
        ...
        "🔧 Modelos de Características": [
            ...
            {"name": "/total_feature_model_downloads", "description": "Total de descargas de modelos de características."},
            {"name": "/total_feature_model_views", "description": "Total de vistas de modelos de características."},
        ],
        "📚 Autores": [
...
@bot.slash_command(name="datasets_counter", description="Cuenta de datasets sincronizados")
...
@bot.slash_command(name="feature_models_counter", description="Cuenta de modelos de características")
...
@bot.slash_command(name="total_dataset_downloads", description="Total de descargas de datasets")
...
@bot.slash_command(name="total_feature_model_downloads", description="📈 Total de descargas de modelos de características")
...
@bot.slash_command(name="total_dataset_views", description="👀 Total de vistas de datasets")
...
@bot.slash_command(name="total_feature_model_views", description="🔍 Total de vistas de modelos de características")
...
class DatasetView(nextcord.ui.View):
    ...
    async def update_message(self, interaction):
        ...
        embed.add_field(name="🧑‍💻 Autor/es", value=", ".join(dataset['authors']) if dataset['authors'] else "No disponible", inline=True)
        embed.add_field(name="📅 Fecha de Creación", value=dataset['created_at'], inline=True)
    ...
    async def download_all(self, button, interaction):
        ...
        await interaction.response.send_message(f"📥 [Haz clic aquí para descargar todos los datasets disponibles]({download_url})", ephemeral=True)
        ...
        formatted_datasets = [
            {
                ...
                "authors": [author.to_dict()['name'] for author in dataset.ds_meta_data.authors]
            }
...
@bot.slash_command(name="most_popular_authors", description="📚 Muestra los autores más populares")
